...
module.exports = {
    ...
    login: async(req, res, next) => {
        try {
            ...
            res.cookie('reftoken', refreshToken, { maxAge: 86_400_000, httpOnly: true, sameSite:false });
            res.cookie('token', accessToken, { maxAge: 300_000, httpOnly: true, sameSite:false });
            res.status(200).json({accessToken, refreshToken});
        } catch (error) {
